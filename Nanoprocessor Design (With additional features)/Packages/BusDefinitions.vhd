...
package BusDefinitions is
    ...
    subtype std_logic_vector_14 is std_logic_vector(13 downto 0);  -- 14-bit instruction word
    ...
    subtype ProgramCounter  is std_logic_vector_4;     -- 4-bit PC (addresses 0-15)
    subtype InstructionWord is std_logic_vector_14;    -- 14-bit instruction (3-bit opcode)
