...
architecture Behavioral of Program_ROM is
    ...
    constant ROM : rom_type := (
        0 => "101110000001",  -- MOVI R7, 1   ; R1 <= 0001  (bits[9:7]="001"=R1)
        1 => "100100000010",  -- MOVI R2, 2   ; R2 <= 0010  (bits[9:7]="010"=R2)
        2 => "001110100000",  -- ADD  R7, R2  ; R1 <= R1+R2 (bits[9:7]="001"=R1, bits[6:4]="010"=R2)
        3 => "100100000011",  -- MOVI R2, 3   ; R2 <= 0011  (bits[9:7]="010"=R2)
        4 => "001110100000",  -- ADD  R7, R2  ; R1 <= R1+R2 (same as addr 2, result = 6)
